<p align="center">
  <img src="assets/profile.jpg" width="112" alt="곽민재 프로필 사진">
</p>

<h1 align="center">곽민재</h1>

<p align="center">
  카메라, LiDAR, IMU 기반 상태추정과 경로계획을 연구하고<br>
...
- 센서융합과 상태추정: 카메라, 2D LiDAR, IMU, DQN, IMM, Kalman Filter
...
| 프로젝트 | 담당 범위 | 대표 결과 |
|---|---|---|
| 강화학습 기반 카메라-LiDAR 센서융합 객체추적 | 연구기획, DQN-IMM 설계, 시뮬레이션, 현장검증 | 현장 위치 RMSE 20.6% 감소, 석사학위논문, ICROS 제1저자 발표, 특허 공동발명 |
| IFAC 2026 RoboRacer | LiDAR 장애물 인지, Frenet 로컬 경로계획 | 56개 팀 중 16강 |
...
- 석사학위논문: 강화학습 기반 단안 카메라와 2D LiDAR 센서융합 알고리즘
...
포트폴리오 전체 구성 파일은 이 저장소의 [`portfolio`](portfolio/) 폴더에도 보관하며, 실제 배포본은 [`neberrein.github.io`](https://github.com/neberrein/neberrein.github.io) 저장소에서 관리합니다.
