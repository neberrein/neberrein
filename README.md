...
<p align="center">
  카메라, 라이다, IMU 기반 상태추정과 경로계획을 연구하고<br>
...
| 프로젝트 | 담당 범위 | 대표 결과 |
|---|---|---|
| 강화학습 기반 카메라-라이다 센서융합 차량 추적 | 연구기획, DQN-IMM 설계, 시뮬레이션, 현장검증 | 현장 위치 RMSE 20.6% 감소, 석사학위논문, ICROS 제1저자 발표, 특허 출원 공동발명 |
| IFAC 2026 RoboRacer | 라이다 장애물 인지, Frenet 로컬 경로계획 | 56개 팀 중 16강 |
| IMU 기반 LSTM-FSM 주행상태 판별 | LSTM 학습, FSM 설계, ROS 통합, 실차검증 | 평균 후진 F1-score 99.52%, SCIE 공동저자 |
| STM32 기반 초음파 표적 탐지 및 추적 | 센서 제어, FreeRTOS 구조, 상태기계, TouchGFX | 5개 태스크, 10개 메시지 큐, 7개 운용 상태 구현 |
...
- 특허 출원 공동발명: 차량 상태 추정 방법, 이를 수행하는 장치 및 기록매체
